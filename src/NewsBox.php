 ...
 */
class NewsBox {
	/** @var array Internal names of skins for which the NewsBox portlet will not be generated */
	public static $blacklisted = [
		// Per discussion with Isarra on 11 January 2014
		'aurora',
		// Hopeless as of late 2025/early 2026.
		'vector-2022'
	];
	...
	public static function getNewsBoxHTML( $skin ) {
		...
		if ( in_array( $skinName, self::$blacklisted ) ) {
			return '';
		}
	...
	public static function render( Skin $skin, &$bar ) {
		if ( !in_array( strtolower( $skin->getSkinName() ), self::$blacklisted ) ) {
			$bar['newsbox-title'] = [];
		}
	}
